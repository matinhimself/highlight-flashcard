...
const DEFAULT_SCHEMA = {
  word: "string - the word or phrase being defined",
  partOfSpeech: "string - part of speech (noun, verb, adjective, etc.)",
  definition: "string - clear, concise definition (1-2 sentences)",
  example: "string - example sentence using the word in context",
  etymology: "string (optional) - origin and history of the word"
};

// Default prompt template
const DEFAULT_PROMPT = `You are a helpful English dictionary assistant. Provide a clear, concise definition for the following word or phrase.
...
// Default prompt template (legacy - markdown format)
const DEFAULT_PROMPT_LEGACY = `You are a helpful English dictionary assistant. Provide a clear, concise definition for the following word or phrase. Include:
